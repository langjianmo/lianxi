...
return [
    ...
    'WebDomainList' => '/data?action=getData&table=domain',	 //获取网站域名列表
    ...
    # 计划任务管理
    'GetCrontab' => '/crontab?action=GetCrontab',            //获取计划任务信息
    'set_cron_status' => '/crontab?action=set_cron_status',  //修改计划任务状态
